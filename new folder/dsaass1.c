...
void findElement(char *str)
{
    ...
    while (temp)
    {
        ...
        if ((res = strcasecmp(temp->word, str)) == 0)
        {
            ...
            {
                char new_meaning[256];
                printf("Enter the new meaning to be updated : ");
                scanf("%[^\n]", &new_meaning);
                strcpy(temp->meaning, new_meaning);
                printf("The new meaning has been updated.\n");
                flag = 1;
                break;
            }
        }
...
void update_the_meaning(char *str)
{
}
...
int main()
{
    ...
    while (1)
    {
        ...
        case 5:
            update_condition = 1;
            printf("Enter the word whose meaning to be updated:");
            fgets(str, 100, stdin);
            findElement(str);
            update_condition = 0;
            break;
